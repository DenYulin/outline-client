    ...
    return html`
      ...
      <app-header-layout fullbleed="">
        ...
        <iron-pages id="pages" selected="[[page]]" attr-for-selected="name">
          ...
          <buypackage-view name="buypackage" id="buypackageView" localize="[[localize]]"></buypackage-view>
          <changenode-view name="changenode" id="changenodeView" servers="[[servers]]" current="{{currentServer}}" localize="[[localize]]"></changenode-view>
          <mystate-view name="mystate" id="mystateView" localize="[[localize]]"></mystate-view>
          <login-view name="login" id="loginView" localize="[[localize]]"></login-view>
          <register-view name="register" id="registerView" localize="[[localize]]"></register-view>
